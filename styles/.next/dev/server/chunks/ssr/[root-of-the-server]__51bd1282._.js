...
async function generateMetadata({ params }) {
    ...
    const auction = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mockAuctions"].find((a)=>a.id === id);
    if (!auction) {
        return {
            title: 'Auction Not Found | Kaspa Auction'
        };
    }
    return {
        title: `${auction.title} | Kaspa Auction`,
        description: auction.description
    };
}
async function AuctionPage({ params }) {
    const { id } = await params;
    const auction = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["mockAuctions"].find((a)=>a.id === id);
    if (!auction) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__51bd1282._.js.map